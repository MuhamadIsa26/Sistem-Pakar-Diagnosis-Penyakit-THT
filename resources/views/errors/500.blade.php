...
<head>
    ...
    <title>500 - Gangguan Internal Server | THT-Pedia</title>
...
<body class="h-full bg-slate-50 flex items-center justify-center p-4 antialiased">
    ...
    <div
        ...
        <div
            class="mb-6 inline-flex items-center justify-center w-20 h-20 bg-amber-50 rounded-full border border-amber-100 text-amber-600 relative">
            <span class="material-symbols-outlined text-4xl font-bold">heart_broken</span>
        ...
        <h1 class="text-xl font-black text-slate-900 tracking-tight mb-2">
            Gangguan Internal Sistem
        </h1>

        <!-- Deskripsi Pesan Eror -->
        <p class="text-xs text-slate-600 font-medium leading-relaxed px-2 mb-8">
            Terjadi kendala teknis pada mesin inferensi atau konektivitas database server kami. Tim teknis sedang
            berupaya melakukan penanganan pemulihan.
        </p>
