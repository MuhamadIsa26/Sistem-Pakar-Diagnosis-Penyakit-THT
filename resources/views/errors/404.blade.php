...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | THT-Pedia</title>
...
<body class="h-full bg-slate-50 flex items-center justify-center p-4 antialiased">
    ...
    <div
        ...
        <div
            class="mb-6 inline-flex items-center justify-center w-20 h-20 bg-emerald-50 rounded-full border border-emerald-100 text-[#00685f] relative">
            <span class="material-symbols-outlined text-4xl font-bold">find_in_page</span>
        ...
        <p class="text-xs text-slate-600 font-medium leading-relaxed px-2 mb-8">
            Mohon maaf, rekam medis atau tautan halaman sistem pakar yang Anda tuju tidak dapat kami temukan di server.
